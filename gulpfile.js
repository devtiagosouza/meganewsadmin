...
gulp.task('copyAddonsScripts', function() {
    ...
    var aScript71 = gulp.src(['node_modules/bootstrap-tour/build/js/bootstrap-tour-standalone.min.js'])
        .pipe(gulp.dest('./vendors/bootstrap-tour'));
    var aScript72 = gulp.src(['node_modules/icheck/skins/**/*'])
        .pipe(gulp.dest('./vendors/icheck/skins'));
    var aScript73 = gulp.src(['node_modules/icheck/icheck.min.js'])
...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle55 = gulp.src(['node_modules/bootstrap-tour/build/css/bootstrap-tour-standalone.min.css'])
        .pipe(gulp.dest('./vendors/bootstrap-tour'));
    var aStyle56 = gulp.src(['node_modules/puse-icons-feather/**/*'])
        .pipe(gulp.dest('./vendors/puse-icons-feather'));
    var aStyle57 = gulp.src(['node_modules/owl-carousel-2/assets/owl.video.play.png'])
        .pipe(gulp.dest('./vendors/owl-carousel-2'));
